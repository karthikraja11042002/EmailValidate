...
public class SecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("/feedback.html", "/script/feedbackquestion.js", "/submitFeedback", "/giveFeedback","/submitRegistration", "/questions.html","/feedbackForm","/results.html","/viewFeedbackbyEmail","/getResult");
    }
